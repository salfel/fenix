build:
	...
	arm-none-eabi-gcc -c src/asm/software_interrupt.S -o out/software_interrupt.o
	arm-none-eabi-gcc -c src/asm/setup.S -o out/setup.o
	arm-none-eabi-ld  -T boot/linker.ld out/start.o out/interrupt.o out/setup.o  out/software_interrupt.o  out/kernel.o -o out/kernel.elf
