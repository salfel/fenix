...
use crate::{
    clock::{self, FunctionalClock}, interrupts::{self, register_handler, Mode}, sys::{clear_bit, noop, read_addr, read_bit, set_bit, write_addr, GPIO1}
};
...
pub fn initialize() {
    clock::enable(FunctionalClock::Gpio1);
